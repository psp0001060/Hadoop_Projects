package com.chinasofti.mr.customsort;
...
public class CustomerSortApp02 {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, CustomerSortApp02.class.getSimpleName());
	...
	static class MyReduce extends
		...
		protected void reduce(CustomerSortKey ck, Iterable<LongWritable> v2s,
            ...
            context.write(new LongWritable(ck.customerKey), new LongWritable(min));
		}
	}
}